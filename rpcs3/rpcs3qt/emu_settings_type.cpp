...
const std::map<emu_settings_type, cfg_location> settings_location =
{
	...
	// RTX Remix
	{ emu_settings_type::RemixNoSun,                       get_cfg_location(local_cfg.video.remix.no_sun) },
	{ emu_settings_type::RemixSunDirection,                get_cfg_location(local_cfg.video.remix.sun_direction) },
	{ emu_settings_type::RemixSunRadiance,                 get_cfg_location(local_cfg.video.remix.sun_radiance) },
	{ emu_settings_type::RemixSunAngle,                    get_cfg_location(local_cfg.video.remix.sun_angular_diameter) },
	{ emu_settings_type::RemixCameraLight,                 get_cfg_location(local_cfg.video.remix.camera_light) },
	{ emu_settings_type::RemixDebugLightRadiance,          get_cfg_location(local_cfg.video.remix.debug_light_radiance) },
	{ emu_settings_type::RemixDebugLightRadius,            get_cfg_location(local_cfg.video.remix.debug_light_radius) },
	...
	{ emu_settings_type::RemixTextureIdle,                 get_cfg_location(local_cfg.video.remix.texture_idle) },
	{ emu_settings_type::RemixFlipTexcoordV,               get_cfg_location(local_cfg.video.remix.flip_texcoord_v) },
	{ emu_settings_type::RemixCameraHold,                  get_cfg_location(local_cfg.video.remix.camera_hold) },
	{ emu_settings_type::RemixCameraTrack,                 get_cfg_location(local_cfg.video.remix.camera_track) },
	...
	{ emu_settings_type::RemixSplitRows,                   get_cfg_location(local_cfg.video.remix.split_rows) },
	{ emu_settings_type::RemixSkyEmissive,                 get_cfg_location(local_cfg.video.remix.sky_emissive) },
	{ emu_settings_type::RemixSkyEmissiveIntensity,        get_cfg_location(local_cfg.video.remix.sky_emissive_intensity) },
	{ emu_settings_type::RemixSkyEmissiveBlend,            get_cfg_location(local_cfg.video.remix.sky_emissive_blend) },
	{ emu_settings_type::RemixMeshCap,                     get_cfg_location(local_cfg.video.remix.mesh_cap) },
	{ emu_settings_type::RemixMeshIdle,                    get_cfg_location(local_cfg.video.remix.mesh_idle) },
	{ emu_settings_type::RemixCategorySky,                 get_cfg_location(local_cfg.video.remix.category_sky) },
	{ emu_settings_type::RemixCategoryHide,                get_cfg_location(local_cfg.video.remix.category_hide) },
	{ emu_settings_type::RemixCategoryParticle,            get_cfg_location(local_cfg.video.remix.category_particle) },
	{ emu_settings_type::RemixCategoryDecal,               get_cfg_location(local_cfg.video.remix.category_decal) },
	{ emu_settings_type::RemixNoUI,                        get_cfg_location(local_cfg.video.remix.no_ui) },
	{ emu_settings_type::RemixUIWidth,                     get_cfg_location(local_cfg.video.remix.ui_width) },
	{ emu_settings_type::RemixKeepRenderTargets,           get_cfg_location(local_cfg.video.remix.keep_render_targets) },
	{ emu_settings_type::RemixClearBackground,             get_cfg_location(local_cfg.video.remix.clear_background) },
	{ emu_settings_type::RemixFarPlane,                    get_cfg_location(local_cfg.video.remix.far_plane) },
	{ emu_settings_type::RemixDump,                        get_cfg_location(local_cfg.video.remix.dump) },
